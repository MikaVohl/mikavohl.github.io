...
export default function Navbar() {
  return (
    <nav className="fixed top-0 z-20 w-full bg-white/70 py-2 font-medium text-base backdrop-blur-lg shadow-sm sm:text-xl">
      <div className="container mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-3 sm:flex-nowrap sm:gap-6 sm:px-4">
        ...
        <ul className="hidden flex-1 items-center justify-center gap-4 text-base sm:flex sm:text-2xl">
          {[
            { id: 'intro', label: 'Home' },
